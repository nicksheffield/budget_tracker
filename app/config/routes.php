...
$routes['item/save']      = 'site/save';
$routes['list']           = 'site/list_items';
$routes['list/:num']      = 'site/list_items/:num';
$routes['list/:num/:num'] = 'site/list_items/:num/:num';
$routes['list/filter']    = 'site/filter_list';
$routes['delete/:num']    = 'site/delete/:num';
$routes['save']           = 'site/save';