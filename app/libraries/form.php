...
class Form{
	...
	*	
	*/
	public static function textarea($name, $value = '', $extras = false){
	...
	*	
	*/
	public static function select($name, $values, $pre_selected = 0, $extras = false){
	...
	*	
	*/
	public static function hidden($name, $value, $extras = false){
	...
	*	
	*/
	public static function text($name, $value = '', $extras = false){
	...
	*	
	*/
	public static function password($name, $value = '', $extras = false){
	...
	*	
	*/
	public static function file($name = 'file', $extras = false){
		$html = self::input('file', $name.'[]', '', $extras.' multiple');
		return $html;
	}
	...
	*	
	*/
	public static function submit($text = 'Submit', $extras = false){
		$html = self::input('submit', '', $text, $extras);
		return $html;
	}

	public function button($text, $extras = false){
		$html = "<button $extras>$text</button>";
		return $html;
	}
